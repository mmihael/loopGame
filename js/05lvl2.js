...
loopGame.lvl2 = function (phaserGame) {};

loopGame.lvl2.prototype = {
  create: function () {
    ...
    for (var i = 0; i < 15; i++)
      for (var j = 0; j < 15; j++) {
        var tile = this.add.sprite(i*32, j*32, 'grass', randomGrass2(i+j));
        tile.scale.x = 0.5;
        tile.scale.y = 0.5;
      }
    ...
    // generating enemies on map
    var positions = [3,7,12,7];
...
// collision handle for group enemies and fire ball
function hitEnemyGroup (fireball, enemy) {
  explosion.revive();
